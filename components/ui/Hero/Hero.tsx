...
const Hero = () => {
  return (
    <div className="flex md:flex-row flex-col py-32 px-24 bg-[#F2F2F2]">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-row ">
              ...
              <span className="flex flex-row items-center ml-3 font-[500] border-2 border-dashed border-black rounded">
                <div className="relative font-lora font-medium italic mx-1 before:absolute before:bg-[#120227] before:h-1 before:left-0 before:right-0 before:bottom-2">
                  tìm kiếm
                </div>
