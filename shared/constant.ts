export const FAQs = [
  ...
  },
  {
    ...
    a: 'Khi book mentor qua nền tảng, bạn sẽ có cơ hội được gặp gỡ với nhiều mentor khác nhau để tìm ra mentor phù hợp với nhu cầu của bạn nhất. Bạn sẽ không phải lo ngại về việc phải dành thời gian để nhắn tin làm quen với mentor hay sắp xếp tìm khung thời gian phù hợp để bạn và mentor có thể gặp nhau. Vì vậy, mặc dù bạn hoàn toàn có thể tự schedule lịch với mentor ở bên ngoài, việc đặt lịch với mentor qua nền tảng sẽ giúp bạn tiết kiệm được nhiều thời gian, công sức hơn và cũng tiện lợi hơn cho mentor của bạn rất nhiều. Đôi khi họ có thể quá bận mà quên trả lời tin nhắn của bạn phải không nào!',
  },
  {
