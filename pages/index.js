...
function HomePage() {
  return (
    <div>
      {/* [] MastHead  */}
      <div
        className="p-20 bg-gradient-to-b from-purple-600 to-purple-800 "
        id="background"
      >
        <div className="container mx-auto">
          <div className="flex md">
            <div className="col inline py-5">
              <h1 className="text-white font-semibold text-4xl my-2">
                SheCodes Mentorship
              </h1>
          ...
          <div className="flex flex-inline align-baseline">
            <div className="col sm px-auto m-5">
              ...
              <p className="text-center">
                Lựa chọn mentor 1-1 có trải nghiệm và background phù hợp với nhu
                cầu của bạn
              </p>
            </div>
            ...
            <div className="col sm px-auto m-5">
              ...
              <p className="text-center">
                Nhận lời khuyên về lộ trình hướng nghiệp cũng như các kỹ năng
                cần chuẩn bị...
              </p>
            </div>
            ...
            <div className="col sm px-auto m-5">
              ...
              <p className="text-center">
                Được chia sẻ về cách tự học và phát triển trong lĩnh vực mà bạn
                mong muốn
              </p>
            </div>
            ...
            <div className="col sm px-auto m-5">
              ...
              <p className="text-center">
                Liên lạc với mentor một cách linh hoạt, không ràng buộc về thời
                gian
              </p>
            </div>
          </div>
