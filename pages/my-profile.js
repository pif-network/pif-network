        ...
        <div className="overflow-hidden w-screen my-3 bg-white">
          ...
          <div className="ml-4 md:ml-92 mb-7 md:mb-16 mt-12 md:mt-0 pt-2">
            ...
            <h6 className="text-xl font-semibold text-primary leading-7">
              {currentUser.school && currentUser.school[0].name}
            </h6>
          </div>
                    ...
                    {currentUser.school &&
                      currentUser.school.map((school, index) => (
                        <li key={index} className="text-primary">
                          <span className="text-black font-semibold text-base leading-5">{school.name}</span>
                          <br />
                          <p className="text-black font-normal text-base leading-5">{school.major}</p>
                        </li>
                      ))}
                  </ul>
                </div>
                  ...
                  <ul className="list-disc list-outside ml-6">
                    {currentUser.exp &&
                      currentUser.exp.map((exp, index) => (
                        <li key={index} className="text-primary">
                          <span className="text-black font-semibold text-base leading-5">{exp.name}</span>
                          <br />
                          <p className="text-black font-normal text-base leading-5">{exp.position}</p>
                        </li>
                      ))}
                  </ul>
                </div>
